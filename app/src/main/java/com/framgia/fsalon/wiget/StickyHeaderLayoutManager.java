...
public class StickyHeaderLayoutManager extends RecyclerView.LayoutManager {
    ...
    /**
     * Callback interface for monitoring when header positions change between members
     * of HeaderPosition enum values.This can be useful if client code wants to change
     * appearance for headers in HeaderPosition.STICKY vs normal positioning.
     *
     * @see HeaderPosition
     */
    public interface HeaderPositionChangedCallback {
         ...
         * HeaderPosition.NONE, HeaderPosition.NATURAL, HeaderPosition.STICKY
         * or HeaderPosition.TRAILING
         *
         * @param sectionIndex the sections [0...n)
         * @param header       the header view
         * @param oldPosition  the previous positioning of the header
         *                     (NONE, NATURAL, STICKY or TRAILING)
    ...
    /**
     * Assign callback object to be notified when a header view position changes
     * between states of the HeaderPosition enum
     *
    ...
    public void onAdapterChanged(RecyclerView.Adapter oldAdapter, RecyclerView.Adapter newAdapter) {
        ...
        try {
            ...
            throw new ClassCastException(
                "StickyHeaderLayoutManager must be used with a RecyclerView where " +
                    "the adapter is a kind of SectioningAdapter");
        }
        removeAllViews();
        headerViews.clear();
    ...
    public void onAttachedToWindow(RecyclerView view) {
        ...
        try {
            ...
            throw new ClassCastException(
                "StickyHeaderLayoutManager must be used with a RecyclerView where the " +
                    "adapter is a kind of SectioningAdapter");
        }
    }
        ...
        if (dy < 0) {
            ...
            while (scrolled > dy) {
                ...
                if (firstViewAdapterPosition > 0 && scrolled > dy) {
                    ...
                    // we're skipping headers. they should already be vended,
                    // but if we're vending a ghostHeader
                    ...
                    if (isGhostHeader) {
                        ...
                        top = bottom -
                            getDecoratedMeasuredHeight(header); // header is already measured
                    } else {
                        measureChildWithMargins(v, 0, 0);
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited to the first
     *                         item not hanging off top of screen or partially obscured by a header
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited
     *                         to the first header not hanging off top of screen
    ...
    /**
     * @param fullyVisibleOnly if true, the search will be limited to the first
     *                         footer not hanging off top of screen or partially obscured by a header
    ...
    /**
     * Updates firstViewAdapterPosition to the adapter position  of the highest item
     * in the list - e.g., the
    ...
    void recordHeaderPositionAndNotify(int sectionIndex, View headerView,
        ...
        if (headerPositionsBySection.containsKey(sectionIndex)) {
            ...
            if (currentHeaderPosition != newHeaderPosition) {
                ...
                if (headerPositionChangedCallback != null) {
                    headerPositionChangedCallback
                        .onHeaderPositionChanged(sectionIndex, headerView, currentHeaderPosition,
                            newHeaderPosition);
                }
            }
        } else {
            ...
            if (headerPositionChangedCallback != null) {
                headerPositionChangedCallback
                    .onHeaderPositionChanged(sectionIndex, headerView, HeaderPosition.NONE,
                        newHeaderPosition);
            }
        }
    }
    ...
    SectioningAdapter.ViewHolder getViewViewHolder(View view) {
        ...
        return (SectioningAdapter.ViewHolder) view
            .getTag(org.zakariya.stickyheaders.R.id.sectioning_adapter_tag_key_view_viewholder);
    }
