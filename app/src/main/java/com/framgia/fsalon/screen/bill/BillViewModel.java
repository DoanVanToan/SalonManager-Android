...
public class BillViewModel extends BaseObservable implements BillContract.ViewModel {
    ...
    public void onBillItemClick(BillItemRequest itemRequest) {
        FragmentTransaction ft = ((AppCompatActivity) mActivity).getSupportFragmentManager()
            .beginTransaction();
        BillDialogFragment newFragment = BillDialogFragment.newInstance(mStylists,
            mServices, itemRequest);
