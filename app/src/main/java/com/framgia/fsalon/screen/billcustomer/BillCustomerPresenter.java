...
/**
 * Listens to user actions from the UI ({@link BillCustomerFragment}), retrieves the data and
 * updates the UI as required.
 */
public class BillCustomerPresenter implements BillCustomerContract.Presenter {
    private static final String TAG = BillCustomerPresenter.class.getName();
    private final BillCustomerContract.ViewModel mViewModel;
    private CompositeDisposable mCompositeDisposable = new CompositeDisposable();
    private BillRepository mBillRepository;

    public BillCustomerPresenter(BillCustomerContract.ViewModel viewModel,
