...
public class BillDialogFragment extends DialogFragment {
    ...
    private BillDialogViewModel.OnClickDialogListener mListener;
    ...
    private void getData() {
        if (getArguments() != null) {
            ...
            mStylistAdapter =
                new ArrayAdapter<>(getContext(), R.layout.item_spinner_small, mStylists);
            mServiceAdapter =
                new ArrayAdapter<>(getContext(), R.layout.item_spinner_small, mServices);
        }
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getData();
        mViewModel =
            new BillDialogViewModel(mStylistAdapter, mServiceAdapter, mBillItemRequest, this,
                mListener);
        BillDialogContract.Presenter presenter = new BillDialogPresenter(mViewModel);
